import { requestRandomVerb, requestVerbConjugations } from "../../apiRequests"
...
export const conjugationTableReducer = (state, action) => {
  ...
  export const conjugationTableInitialState = {
    tableStatus : 'Loading',
    tableData : {
      family: [],
      infinitive: '',
